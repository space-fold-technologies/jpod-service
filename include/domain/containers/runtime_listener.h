...
namespace domain::containers
{
    ...
    {
    public:
        virtual void container_initialized(const std::string &identifier, const std::string &network) = 0;
        ...
        virtual void container_stopped(const std::string &identifier, const std::string &network) = 0;
    };
}
