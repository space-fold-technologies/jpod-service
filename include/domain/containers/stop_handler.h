#ifndef __DAEMON_DOMAIN_CONTAINERS_STOP_HANDLER__
#define __DAEMON_DOMAIN_CONTAINERS_STOP_HANDLER__
...
namespace domain::containers
{
    ...
    class runtime;
    class stop_handler : public core::commands::command_handler
    {
    public:
        stop_handler(
...
#endif //__DAEMON_DOMAIN_CONTAINERS_STOP_HANDLER__