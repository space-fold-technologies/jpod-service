#ifndef __JPOD_SERVICE_CORE_BUS_FUNCTION_TRAITS__
#define __JPOD_SERVICE_CORE_BUS_FUNCTION_TRAITS__

#include <functional>

namespace core::bus::details
{
    template <typename>
    ...
    struct member_fn_type
    {
        typedef typename std::conditional<std::is_const<C>::value,
                                          typename std::conditional<std::is_volatile<C>::value, R (C::*)(A...) const volatile, R (C::*)(A...) const>::type,
                                          typename std::conditional<std::is_volatile<C>::value, R (C::*)(A...) volatile, R (C::*)(A...)>::type>::type type;
    };
    ...
    struct function_traits<ReturnType(Args...)>
    {
        ...
        */
        ...
        using member_function_type =
            typename member_fn_type<typename std::remove_pointer<typename std::remove_reference<OwnerType>::type>::type,
                                    ReturnType,
                                    Args...>::type;
...
#endif // __JPOD_SERVICE_CORE_BUS_FUNCTION_TRAITS__